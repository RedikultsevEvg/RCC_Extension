...
namespace Test.SC.CheckSteelBase.CheckPressure
{
    ...
    //        steelColumnBase.UseSimpleMethod = true;
    ...
    //        Assert.AreEqual(Expected, Actual, (-1.0) * Expected * tolerance);
    //    }
    //    [TestMethod]
    //    //Расчет давления
    ...
    //    [TestMethod]
    //    //Расчет давления
    //    public void CheckMaxPressure1_nonLinear10()
    //    {
    //        double N = -216 * 1e3;
    //        double M = 74.38 * 1e3;
    //        double baseWidth = 0.4;
    ...
    //        steelColumnBase.Length = baseLength;
    //        steelColumnBase.Thickness = 0.05;
    //        steelColumnBase.UseSimpleMethod = false;
    //        steelColumnBase.ConcreteStrength = 10 * 1e6;
    ...
    //        double Expected = -5290511;
    //        Assert.AreEqual(Expected, Actual, (-1.0) * Expected * tolerance);
    //    }
    //    [TestMethod]
    //    //Расчет давления
    //    public void CheckMaxPressure1_nonLinear20()
    //    {
    //        double N = -216 * 1e3;
    //        double M = 74.38 * 1e3;
    //        double baseWidth = 0.4;
    ...
    //        steelColumnBase.Thickness = 0.05;
    //        steelColumnBase.UseSimpleMethod = false;
    //        steelColumnBase.ConcreteStrength = 20 * 1e6;
    ...
    //        double Actual = SteelBasePartProcessor.GetGlobalMinStressNonLinear(steelColumnBase.ActualSteelBaseParts[1]);
    //        double Expected = -5993772;
    //        Assert.AreEqual(Expected, Actual, (-1.0) * Expected * tolerance);
    //    }
    //    [TestMethod]
    //    //Расчет давления
    //    public void CheckMaxPressure2_nonLinear10()
    //    {
    //        double N = -95 * 1e3;
    //        double M = 83.14 * 1e3;
    //        double baseWidth = 0.4;
    ...
    //        #endregion
    //        double Actual = SteelBasePartProcessor.GetGlobalMinStressNonLinear(steelColumnBase.ActualSteelBaseParts[1]);
    //        double Expected = -5127021;
    //        Assert.AreEqual(Expected, Actual, (-1.0) * Expected * tolerance);
    //    }
    //    [TestMethod]
    //    //Расчет давления
    //    public void CheckMaxPressure2_nonLinear20()
    //    {
    //        double N = -95 * 1e3;
    //        double M = 83.14 * 1e3;
    //        double baseWidth = 0.4;
