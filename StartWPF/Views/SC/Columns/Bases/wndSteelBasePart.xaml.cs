...
namespace RDStartWPF.Views.SC.Columns.Bases
{
    ...
    public partial class WndSteelBasePart : Window
    {
        ...
        public WndSteelBasePart(SteelBase steelColumnBase)
        {
            ...
            _SteelBasePartsPgVM = new SteelBasePartsPgVM(_steelColumnBase.SteelBaseParts, _steelColumnBase);
        }
        ...
        private void Parts_Navigated(object sender, System.Windows.Navigation.NavigationEventArgs e)
        {
            pgSteelBaseParts pgSteelBaseParts = new pgSteelBaseParts();
            var page = Parts.Content as Page;
